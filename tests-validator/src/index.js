...
const { logger, schemaBuilder, utils, printErrors, printFileError } = require('../lib');
const YAMLException = require('js-yaml/lib/js-yaml/exception');
...
const validateSchema =  (targetObject, options = {}) => {
  ...
  try {
    ...
    if(error instanceof YAMLException) {
      return printFileError(targetObject);
    }
  }
}
