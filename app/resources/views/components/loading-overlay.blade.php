<div class="loading-overlay">
    <svg width="75px" height="75px" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <mask id="circleMask">
            ...
            <circle cx="50" cy="5" r="15" fill="black">
                <animateTransform attributeName="transform" attributeType="XML" type="rotate"
                    from="30 50 50" to="390 50 50" dur="2s" repeatCount="indefinite" />
            </circle>
            <circle cx="50" cy="5" r="15" fill="black">
                <animateTransform attributeName="transform" attributeType="XML" type="rotate"
                    from="60 50 50" to="420 50 50" dur="2s" repeatCount="indefinite" />
            </circle>
        </mask>

        <!-- Main Circle with Mask Applied -->
        <circle cx="50" cy="50" r="45" stroke="#5f9ea0" fill="none"
            stroke-width="5" mask="url(#circleMask)" />
