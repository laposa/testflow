    ...
    <tbody>
        @foreach ($suites as $path => $suite)
            <tr>
                ...
                <td><span class="expand"
                        data-target="selector-suite-tests-{{ $path }}">Expand</span></td>
            </tr>
                            ...
                            <tr>
                                <td>
                                    @if ($select)
                                        <div>
                                            <label
                                                for="selector-test-{{ $path . $test['test_name'] }}"
                                                class="checkbox suite">
                                                <input class="test-selector" type="checkbox"
                                                    data-parent="{{ $path }}"
                                                    id="selector-test-{{ $path . $test['test_name'] }}"
                                                    name="tests[]"
