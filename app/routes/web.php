...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/sessions', [\App\Http\Controllers\SessionController::class, 'index'])->name(
        'sessions.index',
    );
    ...
    Route::post('/sessions', [\App\Http\Controllers\SessionController::class, 'store'])->name(
        'sessions.store',
    );
     ...
     */
    Route::get('/sessions/{session}/run/{run}', [
